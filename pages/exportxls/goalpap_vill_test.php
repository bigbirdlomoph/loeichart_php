...
?>
<a href="../exportxls/goalpap_vill_export_excel.php?hcode=<?=$arr_rs['HCODE'];?>&villid=<?=$arr_rs['VILLCODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
