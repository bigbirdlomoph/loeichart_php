...
?>
<?php
$strExcelFileName=$hcode."anc_12_week.xls";
...
header("Pragma:no-cache");
 ...
 $db->Query("
			 SELECT 
					...
					WHERE  zat.hospcode='$hcode' AND FANC BETWEEN'$ystr' AND'$yend'
...
?>
<br>
ANC12=0 ได้รับ ANC มากกว่า 12 สัปดาห์ &nbsp;&nbsp; ANC12=1 ได้รับ ANC น้อยกว่าหรือเท่ากับ 12 สัปดาห์
