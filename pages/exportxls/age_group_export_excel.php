...
?>
<?php
$strExcelFileName=$age."age_group.xls";
...
<td width="200" align="center" valign="middle" ><strong>จำนวนประชากร</strong></td>
<td width="181" align="center" valign="middle" ><strong>ชาย</strong></td>
<td width="181" align="center" valign="middle" ><strong>หญิง</strong></td>
...
<td align="center" valign="middle" ><?php echo $row['SUMMARY'];?></td>
<td align="center" valign="middle"><?php echo $row['MALE'];?></td>
<td align="center" valign="middle"><?php echo $row['FEMALE'];?></td>
