...
header("Pragma:no-cache");
 ...
 $db->Query("SELECT * FROM z42_anc_hr_visit_t where HOSPCODE='$hcode' and CHK='1' and fanc BETWEEN '$ystr' AND '$yend'");
 $num=$db->Numrow();
?>
...
<td width="185" align="center" valign="middle" ><strong>ได้รับการเยี่ยมบ้าน</strong></td>
...
<td align="center" valign="middle"><?php if($chk=='1'){echo "ได้รับการเยี่ยม";}else{echo'';}?></td>
