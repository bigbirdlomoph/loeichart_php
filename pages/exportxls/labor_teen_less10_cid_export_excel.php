...
?>
<?php
$strExcelFileName=$age."labor_teen_less10_individual.xls";
...
header("Pragma:no-cache");
 ...
 $db->Query("
         SELECT  
            ...
            t.BIRTH,t.AGE,a.GRAVIDA,MIN(a.DATE_SERV) AS FANC,a.GA,t.HOUSE,
            t.VHID,cvl.villname AS VILLNAME,t.BDATE,CONCAT(p.TYPEAREA,'-',c.typeareaname)AS TYPREAREA
        FROM t_labor_teen t
