...
<?php
 ...
 $dbrpt->Query("select * from z42_disab_pmj_no43_tambon_s where ampcode=$ampcode and hospcode=$hospcode");
...
?>    
	<tr>
		<td>
         <a href="disab_pmj_no43_vill.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&tcode=<?php echo $arr_rs['TCODE'];?>&id=<?php echo $id;?>&hospcode=<?php echo $arr_rs['HOSPCODE']?>"><?php echo $arr_rs['TNAME']; ?></a>
