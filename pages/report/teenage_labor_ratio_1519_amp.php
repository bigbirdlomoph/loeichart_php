...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละของการคลอดโดยมารดาที่มีอายุ 15-19 ปี ต่อการคลอดทั้งหมด
  ...
  <a href="../exportxls/labor_teen1519_amp_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&id=<?php echo $id ;?>&o_year=<?php echo $o_year;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
...
<thead class="bg-success">
  ...
  <tr>
    ...
    <td><div align="center">ต่อพันประชากร</div></td>
...
(
	SELECT 
				...
				sum(target) as B,
				sum(result) as A,
				ROUND((sum(result)/sum(target))*1000,2) as P,
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('teenage_lborn_1519_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>
