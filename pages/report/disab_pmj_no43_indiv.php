  ...
  $dbrpt->Query("SELECT * FROM z42_sys_report WHERE id='$id' ORDER BY cat_id");
    while($arrrpt=$dbrpt->Fetch_array()){
		...
		<h4><?php echo $arrrpt['report_name'];?> 
         <a href="../exportxls/disab_pmj_no43_vill_export_excel.php?id=<?php echo $id;?>&hospcode=<?php echo $hospcode;?>&vhid=<?php echo $vhid;?>" class="btn btn-default btn-sm " role="button">Excel</a>
        </h4>
		<?php
        }
...
<?php
 ...
 $i=1; 
 $dbrpt->Query("select * from z42_disab_pmj_no43_t where HOSPCODE=$hospcode and VHID=$vhid ");
