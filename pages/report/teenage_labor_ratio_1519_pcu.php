...
?>
<a href="../exportxls/labor_teen1519_pcu_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&ampcode=<?php echo $ampcode ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
...
<thead class="bg-success">
  ...
  <tr>
    ...
    <th><div align="center">ต่อพันประชากร</div></th>
...
<?php
 ...
 $dbrpt->Query("
				SELECT 
					...
					left  OUTER JOIN z42_co_office_loei AS 42loei on 42loei.off_id = s_labor_midyear_1519.hospcode
