...
<?php
 ...
 $dbrpt->Query("
				SELECT 
					...
					left  OUTER JOIN z42_co_office_loei AS 42loei on 42loei.off_id = z42_anc12w_s_error.hospcode
...
?>    
	<tr>
		<td>
         <a href="javascript:popup('anc_report_12w_pcu_cid_error.php?hcode=<?php echo $arr_rs['HCODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['HNAME']; ?></a>     
		</td>
        ...
        <?php echo $arr_rs['M09']; ?>
         ...
         <td align="center"><a href="../exportxls/anc_12w_export_excell_error.php?hcode=<?php echo $arr_rs['HCODE'];?>&id=<?php echo $id ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" title="ส่งออก Excell"><i class="fa fa-file-excel-o"></i></a></td>
	</tr>
