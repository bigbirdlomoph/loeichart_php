...
?>
<a href="../exportxls/goalpap_pcu_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&ampcode=<?php echo $ampcode ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
...
<?php
 ...
 $dbrpt->Query("
        SELECT 
          ...
          FROM s_goalpap 
          INNER JOIN z42_co_office_loei AS 42loei on 42loei.off_id = s_goalpap.hospcode
...
?>    
	<tr>
		<td>
         <a href="javascript:popup('goalpap_vill.php?hcode=<?=$arr_rs['HCODE'];?>&villid=<?=$arr_rs['AREACODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['HNAME']; ?></a></td>
