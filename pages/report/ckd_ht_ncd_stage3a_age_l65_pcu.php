...
?>
<a href="../exportxls/ht_ckd_stage3a_age_l65_pcu_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&ampcode=<?php echo $ampcode ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
  <div class="panel-body">
  A = จำนวนผู้ป่วย HT ที่ได้รับการคัดกรองภาวะแทรกซ้อนทางไตพบ CKD Stage2 (eGFR 45-59) อายุน้อยกว่า 65 ปี<br>
...
?>    
	<tr>
		<td>
         <a href="javascript:popup('ckd_ht_ncd_stage3a_age_l65_pcu_cid.php?hcode=<?php echo $arr_rs['HCODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['HNAME']; ?></a></td>
