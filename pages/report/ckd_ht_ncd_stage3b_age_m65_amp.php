...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละผู้ป่วย HT ที่มีภาวะไตเสื่อม (CKD) stage3b อายุมากกว่า 65 ปี
  <a href="javascript:popup('../chart/chart_ckd_ht_age_m65_stage3b_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart   
   </a>
  <a href="../exportxls/ht_ckd_stage3b_age_m65_amp_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&id=<?php echo $id ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>

     <div class="panel-body">
  A = จำนวนผู้ป่วย HT ที่ได้รับการคัดกรองภาวะแทรกซ้อนทางไตพบ CKD Stage3b (eGFR 30-44) อายุมากกว่า 65 ปี<br>
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('ckd_ht_ncd_stage3b_age_m65_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>
