...
?>
<a href="../exportxls/goalpap_59_vill_export_excel.php?villid=<?=$villid;?>&hcode=<?=$hcode;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
...
?>    
	<tr>
		<td>
        <a href="javascript:popup('goalpap_59_pcu_cid.php?villid=<?php echo $arr_rs['VILLCODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['VNAME']; ?></a></td>
