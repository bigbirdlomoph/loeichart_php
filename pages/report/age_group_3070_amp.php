...
<title>ข้อมูล กลุ่มอายุ <?php echo $age;?> ปี ระดับอำเภอ</title>
...
<div class="panel panel-success">
 <div class="panel-heading"><i class="fa fa-chain"></i> กราฟ</div>
  ...
  <?php include("../chart/chart_3060_amp.php")?>
...
<!---->
 <div class="panel panel-info">
  <div class="panel-heading">ข้อมูล กลุ่มอายุ <?php echo $age;?> ปี ระดับอำเภอ</div>
     <div class="panel-body">
...
?>    
	<tr>
		<td>
         <a href="javascript:popup('age_group_3070_tambon.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>&age=<?php echo $age?>&table=<?php echo $table_t?>','',960,500)"><?php echo $arr_rs['AMPNAME']; ?></a>
