...
รายชื่อผู้ป่วย DM ที่มีภาวะไตเสื่อม (CKD) Stage1   
<a href="../exportxls/ckd_stage1_cid_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&hcode=<?php echo $hcode ;?>&id=<?php echo $id ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
...
<?php
 ...
 $dbrpt->Query("
    SELECT  
        ...
        AND t.LABRESULT BETWEEN '90.00' AND '119.99' ;
		");
