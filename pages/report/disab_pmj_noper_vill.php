...
<?php
 ...
 $dbrpt->Query("select * from z42_disab_pmj_noper_vill_s where ampcode=$ampcode and hospcode=$hospcode and tcode=$tcode");
...
?>    
	<tr>
		<td>
         <a href="disab_pmj_noper_indiv.php?hospcode=<?php echo $arr_rs['HOSPCODE'];?>&vhid=<?php echo $arr_rs['VHID'];?>&id=<?php echo $id;?>"><?php echo $arr_rs['VNAME']; ?></a>      
