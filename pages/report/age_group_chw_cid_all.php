...
<div class="panel-heading">ข้อมูล กลุ่มอายุ <?php echo $age_st;?> ถึง <?php echo $age_end;?> ปีขึ้นไป ระดับสถานบริการ 
<br><a <a href="javascript:history.go(-1)" class="btn btn-default btn-sm " role="button">Back</a>
<a <a href="../exportxls/age_group_chw_05_export_excel.php?id=<?php echo $id;?>&tambon=<?php echo $tambon;?>&table=<?php echo $table;?>&age_st=<?php echo $age_st;?>&age_end=<?php echo $age_end;?>" class="btn btn-default btn-sm " role="button">Excel</a>
</div>
...
<thead>
          <tr>
             ...
             <th>อายุ/ปี</th>
             <?php if($age_st<>'0'){}else{?><th>อายุ/เดือน</th> <?php }?>
...
?>    
	<tr>
		...
		if($age_st=='0'){
         ...
         if ($age_m=='9' xor $age_m=='18' xor $age_m=='30' xor $age_m=='42'){
		 	?>
			<td>
