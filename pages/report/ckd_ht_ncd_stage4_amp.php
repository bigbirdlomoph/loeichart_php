...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละผู้ป่วย HT ที่มีภาวะไตเสื่อม (CKD) stage4
  <a href="javascript:popup('../chart/chart_ckd_ht_ncd_stage4_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart   
   </a>
  ...
  A = จำนวนผู้ป่วย HT ที่ได้รับการคัดกรองภาวะแทรกซ้อนทางไตพบ CKD Stage4 (eGFR 15-29) <br>
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('ckd_ht_ncd_stage4_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>
