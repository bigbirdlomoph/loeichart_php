...
<?php
 ...
 $dbrpt->Query("select * from z42_60up_functional_pcu_s where ampcode=$ampcode");
...
?>    
	<tr>
		<td>
         <a href="60up_functional_tambon.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>&hospcode=<?php echo $arr_rs['HOSPCODE']?>"><?php echo $arr_rs['HOSPNAME']; ?></a>           
		</td>
