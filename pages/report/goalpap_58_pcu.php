...
?>    
	<tr>
		<td>
         <a href="javascript:popup('goalpap_58_vill.php?hcode=<?=$arr_rs['HCODE'];?>&villid=<?=$arr_rs['AREACODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['HNAME']; ?></a></td>
