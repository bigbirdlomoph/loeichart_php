 ...
 //select name report
  $dbrpt->Query("SELECT * FROM z42_sys_report WHERE id='$id' ORDER BY cat_id");
    while($arrrpt=$dbrpt->Fetch_array()){
        ...
        <a href="../exportxls/60up_disab_indiv_export_excel.php?id=<?php echo $id;?>&hospcode=<?php echo $hospcode;?>&vhid=<?php echo $vhid;?>" class="btn btn-default btn-sm " role="button">Excel</a>
        </h4>
		<?php
        }
...
<?php
 ...
 $i=1; 
 $dbrpt->Query("select * from z42_disab_t where HOSPCODE=$hospcode and VHID=$vhid and age>=60 ORDER BY HOSPCODE,CID");
