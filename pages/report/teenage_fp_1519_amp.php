...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละของวัยรุ่นอายุ 15-19 ปี ที่ได้รับบริการคุมกำเนิดหลังคลอดหรือแท้งก่อนออกจากโรงพยาบาล
  <a href="javascript:popup('../chart/chart_teenage_lborn_fp_1519_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart
   </a>
...
(
	SELECT 
				...
				LEFT OUTER JOIN z42_amp AS amp ON LEFT(s_labor_fp_1519.areacode,4)=amp.AMP_CODE
