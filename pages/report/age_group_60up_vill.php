...
?>    
	<tr>
	  ...
	  ?>
		<td>
         <a href="age_group_60up_cid.php?vhid=<?php echo $arr_rs['VHID'];?>&age=<?php echo $age;?>&table=<?php echo $table;?>"><?php echo $arr_rs['VILLNAME']; ?></a>     
		</td>
       <?php
	  }else{ 
	   ?> 
	    <td>
         <a href="age_group_60up_cid_all.php?id=<?php echo $id;?>&tambon=<?php echo $tambon;?>&table=<?php echo $table;?>&age=<?php echo $age;?>"><?php echo $arr_rs['VILLNAME']; ?></a>     
		</td>
