...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละผู้ป่วย DM ที่มีภาวะไตเสื่อม (CKD) Stage4 อายุน้อยกว่า 65 ปี
  <a href="javascript:popup('../chart/chart_ckd_age_l65_stage4_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart
   </a>
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('ckd_ncd_stage4_age_l65_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>
