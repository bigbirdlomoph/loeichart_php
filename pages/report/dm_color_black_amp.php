...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">จำนวนผู้ป่วยเบาหวาน สีดำ 
  <a href="javascript:popup('../chart/chart_dm_color_black_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart
   </a>

</div>
     <div class="panel-body">
    A = จำนวนผู้ป่วยเบาหวานที่มีภาวะแทรกซ้อนทาง ตา ไต หัวใจ เท้า<br>
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('dm_color_black_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['AMPNAME']; ?></a>
