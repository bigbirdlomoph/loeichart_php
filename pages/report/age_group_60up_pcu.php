...
<?php
$tambon=$_GET['tambon'];
$ampcode=substr($_GET['tambon'],0,4);
$id=$_GET['id'];
$age=$_GET['age'];
$table=$_GET['table'];
...
?>    
	<tr>
		<td>
         <a href="age_group_60up_vill.php?hcode=<?php echo $arr_rs['HOSPCODE'];?>&id=<?php echo $id?>&age=<?php echo $age;?>&table=<?php echo $table;?>&tambon=<?php echo $tambon;?>"><?php echo $arr_rs['HOSPNAME']; ?></a>     
		</td>
        <td>
