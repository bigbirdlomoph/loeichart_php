 ...
 //select name report
  $dbrpt->Query("SELECT * FROM z42_sys_report WHERE id='$id' ORDER BY cat_id");
    while($arrrpt=$dbrpt->Fetch_array()){
        ...
        <a href="../exportxls/60up_chronic_amp_export_excel.php?id=<?php echo $id;?>&table=<?php echo $table;?>" class="btn btn-default btn-sm " role="button">Excel</a>
        </h4>
		<?php
        }
...
?>    
	<tr>
		<td>
         <a href="javascript:popup('60up_chronic_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>','',960,500)"><?php echo $arr_rs['AMPNAME']; ?></a>
		</td>
