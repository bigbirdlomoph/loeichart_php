...
<a href="../exportxls/goalpap_58_cid_export_excel.php?villid=<?=$villid;?>&hcode=<?php echo $hcode ;?>&id=<?php echo $id ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
<br> สถานะการคัดกรอง <br>
0 = ยังไม่ได้รับการคัดกรอง <br>
2 = คัดกรองแล้ว <br>
3 = คัดกรองแล้วในปีงบประมาณ 2558 <br>
</div>
...
<?php
 ...
 $dbrpt->Query("
            SELECT 
                ...
                v.villid AS VILLCODE,
                CASE WHEN a.pap_ck='0' THEN '#DC143C'   
                WHEN a.pap_ck='2' THEN '' ELSE 'SCREEN_PAP_SMEAR' END AS PAP_CHK
