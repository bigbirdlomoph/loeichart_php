...
<?php
 ...
 $dbrpt->GET_AGE_GROUP_CHM_PCU($table,$age_m,$tambon);
while($arr_rs=$dbrpt->Fetch_array()){
	
?>    
	<tr>
		<td>
         <a href="age_group_chm_vill.php?hcode=<?php echo $arr_rs['HOSPCODE'];?>&id=<?php echo $id;?>&age_st=<?php echo $age_st;?>&age_end=<?php echo $age_end;?>&age_m=<?php echo $age_m;?>&table=<?php echo $table?>&tambon=<?php echo $tambon;?>"><?php echo $arr_rs['HOSPNAME']; ?></a>     
		</td>
        <td>
