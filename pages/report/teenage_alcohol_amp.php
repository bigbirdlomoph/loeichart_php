...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละประชากรอายุ 15-19 ปี ดื่มสุรา 
  <a href="javascript:popup('../chart/chart_teenage_alcohol_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart
   </a>
...
(
    SELECT 
                ...
                FROM z42_tmp_alcohol_s 
                LEFT OUTER JOIN z42_amp AS amp ON LEFT(z42_tmp_alcohol_s.areacode,4)=amp.AMP_CODE
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('teenage_alcohol_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['AMPNAME']; ?></a>
