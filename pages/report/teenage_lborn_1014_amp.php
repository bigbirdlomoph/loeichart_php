...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละของการคลอดโดยมารดาที่มีอายุ 10-14 ปี ต่อการคลอดทั้งหมด
  <a href="javascript:popup('../chart/chart_teenage_lborn_1014_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart
   </a>
  ...
  A = จำนวนเด็กคลอดจากแม่อายุ 10-14 ปี (นับเฉพาะคลอดมีชีพ) <br>
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('teenage_lborn_1014_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>
