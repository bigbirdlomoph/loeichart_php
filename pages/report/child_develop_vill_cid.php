...
<a href="../exportxls/child_develop_cid_export_excel.php?id=<?php echo $id?>&fyear=<?php echo $fyear;?>&age=<?php echo $age?>&table=<?php echo $tb_pcu?>&vhid=<?php echo $vhid;?>&hospcode=<?php echo $hcode;?>"class="btn btn-default btn-sm " role="button">
   ส่งออก Excel
   </a>
<?php	
	}else{
