...
<?php
 ...
 $dbrpt->Query("select * from z42_60up_disab_tambon_s where ampcode=$ampcode and hospcode=$hospcode");
...
?>    
	<tr>
		<td>
         <a href="60up_disab_vill.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&tcode=<?php echo $arr_rs['TCODE'];?>&id=<?php echo $id;?>&hospcode=<?php echo $arr_rs['HOSPCODE']?>"><?php echo $arr_rs['TNAME']; ?></a>    
		</td>
