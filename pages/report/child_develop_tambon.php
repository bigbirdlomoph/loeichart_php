...
//check table
if($fyear=='2558'){ 
		if($age==9){$tb_pcu="z42_child_dev_s_tmb";}
		elseif($age==18){$tb_pcu="z42_child_dev_s18_tmb";}
		elseif($age==30){$tb_pcu="z42_child_dev_s30_tmb";}
		elseif($age==42){$tb_pcu="z42_child_dev_s42_tmb";}
}else{
		if($age==9){$tb_pcu="z42_child_dev_s_".substr($fyear,2,2)."_tmb";}
		elseif($age==18){$tb_pcu="z42_child_dev_s18_".substr($fyear,2,2)."_tmb";}
		elseif($age==30){$tb_pcu="z42_child_dev_s30_".substr($fyear,2,2)."_tmb";}
		elseif($age==42){$tb_pcu="z42_child_dev_s42_".substr($fyear,2,2)."_tmb";}
 ...
 //select name report
  $dbrpt->Query("SELECT * FROM z42_sys_report WHERE id='$id' ORDER BY cat_id");
    while($arrrpt=$dbrpt->Fetch_array()){
        ...
        <a href="../exportxls/child_develop_tmb_export_excel.php?id=<?php echo $id?>&fyear=<?php echo $fyear;?>&age=<?php echo $age?>&table=<?php echo $tb_pcu?>&ampcode=<?php echo $ampcode;?>&hospcode=<?php echo $hospcode;?>"class="btn btn-default btn-sm " role="button">
   ส่งออก Excel
   </a>
        </h4>
		<?php
...
<?php
 ...
 $dbrpt->Query(" SELECT * FROM $tb_pcu WHERE hospcode='".$hospcode."' and left(subdistid,4)='".$ampcode."'");
...
?>    
	<tr>
		...
		<td class="bg-info">
         <a href="child_develop_vill.php?id=<?php echo $id;?>&ampcode=<?php echo $ampcode;?>&hospcode=<?php echo $arr_rs['hospcode'];?>&subdistid=<?php echo $arr_rs['subdistid'] ?>&age=<?php echo $age;?>&fyear=<?php echo $fyear;?>"><?php echo $arr_rs['subdistname']; ?></a> 
		</td>
        <td align="center">
