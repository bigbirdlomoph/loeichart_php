...
<?php
 ...
 $dbrpt->Query("
	SELECT 
					...
					sum(target) as B,
					sum(result) as A,
					IF(ROUND((sum(result)/sum(target))*100,2)=0,'100',ROUND((sum(result)/sum(target))*100,2)) as P,
					...
					left  OUTER JOIN z42_co_office_loei AS 42loei on 42loei.off_id = z42_anc_hr_visit_s.hospcode
...
?>    
	<tr>
		<td>
         <a href="hirisk_anc_homecare_pcu_cid.php?hcode=<?php echo$arr_rs['HCODE'];?>&b_year=<?php echo$b_year?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>"><?php echo $arr_rs['HNAME']; ?></a>     
		</td>
        ...
        <?php echo $arr_rs['M09']; ?>
          ...
          <td align="center"><a href="../exportxls/hirisk_anc_homcare_export_excell.php?hcode=<?php echo $arr_rs['HCODE'];?>&id=<?php echo $id ;?>&b_year=<?php echo $b_year?>&ystr=<?php echo $ystr?>&yend=<?php echo $yend ;?>" title="ส่งออก Excell"><i class="fa fa-file-excel-o"></i></a></td>
