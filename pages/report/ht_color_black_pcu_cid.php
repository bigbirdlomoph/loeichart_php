...
<?php
 ...
 $dbrpt->Query("
    SELECT  
        ...
        t.BIRTH,t.AGE,s.sexname AS SEX,t.DATE_SERV,t.DIAG,
        CONCAT(t.SBP,' / ',t.DBP)AS BP, t.HT_com,  t.HOUSE,t.VHID,
        cvl.villname AS VILLNAME,CONCAT(t.TYPEAREA,'-',c.typeareaname)AS TYPREAREA
        FROM z42_t_ht_color t
        LEFT JOIN loeichart.co_village_loei as cvl ON t.VHID=cvl.villid AND t.HOSPCODE=cvl.hospcode
...
?>    
    <tr>
        ...
        <td><?php echo $arr_rs['CID']; ?></a></td>
        <td><?php echo $arr_rs['FULLNAME']; ?></td>
        <td><?php echo $arr_rs['BIRTH']; ?></td>
        <td><?php echo $arr_rs['AGE']; ?></td>
        <td><?php echo $arr_rs['SEX']; ?></td>
        <td><?php echo $arr_rs['DATE_SERV']; ?></td>
        <td><?php echo $arr_rs['DIAG']; ?></td>
        <td><?php echo $arr_rs['BP']; ?></td>
        <td><?php echo $arr_rs['HT_com']; ?></td>
        <td><?php echo $arr_rs['HOUSE']; ?></td>
        <td><?php echo substr($arr_rs['VHID'],6,2); ?></td>
        <td><?php echo $arr_rs['VILLNAME']; ?></td>
        <td><?php echo $arr_rs['TYPREAREA']; ?></td>
  </tr>
