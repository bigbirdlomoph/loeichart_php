...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละการคัดกรองมะเร็งปากมดลูก ในปีงบประมาณ QOF 2559 (1 เม.ย. 2558 ถึง 31 มี.ค. 2559)
  <a href="javascript:popup('../chart/chart_goalpap_59_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart   
   </a>
  <a href="../exportxls/goalpap_59_amp_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&id=<?php echo $id ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>

     <div class="panel-body">
  A = ประชากรหญิง อายุ 30-60 ปี ที่ต้องได้รับการคัดกรองมะเร้งปากมดลูกในปี QOF 2559  <br>
...
(
  SELECT 
        ...
        FROM s_goalpap_59
        LEFT OUTER JOIN z42_amp AS amp ON LEFT(s_goalpap_59.areacode,4)=amp.AMP_CODE 
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('goalpap_59_pcu.php?ampcode=<?=$arr_rs['AMPCODE'];?>&id=<?php echo $id;?>
