...
<?php
 ...
 $dbrpt->Query("
	SELECT 
					...
					FROM z42_anc_hr_s 
					left  OUTER JOIN z42_co_office_loei AS 42loei on 42loei.off_id = z42_anc_hr_s.hospcode
...
?>    
	<tr>
		<td>
         <a href="hirisk_anc_pcu_cid.php?hcode=<?php echo$arr_rs['HCODE'];?>&b_year=<?php echo$b_year?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>"><?php echo $arr_rs['HNAME']; ?></a>     
		</td>
        ...
        <?php echo $arr_rs['M09']; ?>
          ...
          <td align="center"><a href="../exportxls/hirisk_anc_export_excell.php?hcode=<?php echo $arr_rs['HCODE'];?>&id=<?php echo $id ;?>&b_year=<?php echo$b_year?>" title="ส่งออก Excell"><i class="fa fa-file-excel-o"></i></a></td>
