...
?>    
	<tr>
		<td>
         <a href="javascript:popup('age_group_3060_vill.php?tambon=<?php echo $arr_rs['subdistid'];?>&id=<?php echo $id;?>&age=<?php echo $age;?>&table=<?php echo $table;?>','',960,500)"><?php echo $arr_rs['TBNAME']; ?></a>     
		</td>
        <td>
