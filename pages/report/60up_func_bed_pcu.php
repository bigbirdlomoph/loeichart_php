...
<?php
 ...
 $dbrpt->Query("select * from z42_60up_func_bed_pcu_s where ampcode=$ampcode");
...
?>    
	<tr>
		<td>
         <a href="60up_func_bed_tambon.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>&hospcode=<?php echo $arr_rs['HOSPCODE']?>"><?php echo $arr_rs['HOSPNAME']; ?></a>           
		</td>
