...
รายชื่อผู้ป่วย DM ที่มีภาวะไตเสื่อม (CKD) Stage3a
<a href="../exportxls/ckd_stage3b_cid_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&hcode=<?php echo $hcode ;?>&id=<?php echo $id ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
...
<?php
 ...
 $dbrpt->Query("
    SELECT  
        ...
        WHERE t.DATE_SERV BETWEEN '$ystr' AND '$yend' AND t.HOSPCODE='$hcode' AND LEFT(t.DIAG,1)='E' 
        AND t.LABRESULT BETWEEN '30.00' AND '44.99' ;
        ");
