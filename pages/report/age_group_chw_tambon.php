...
<title>ข้อมูล กลุ่มอายุ <?php echo $age_st;?> ถึง <?php echo $age_end;?> ปีขึ้นไป ระดับตำบล</title>
     <!-- Bootstrap Core CSS -->
...
<?php
 ...
 $dbrpt->GET_AGE_GROUP_CHW_TAMBON($table,$age_st,$age_end,$ampcode);
while($arr_rs=$dbrpt->Fetch_array()){
	
?>    
	<tr>
		<td>
         <a href="age_group_chw_pcu.php?tambon=<?php echo $arr_rs['TBCODE'];?>&id=<?php echo $id;?>&age_st=<?php echo $age_st;?>&age_end=<?php echo $age_end;?>"><?php echo $arr_rs['TBNAME']; ?></a>     
		</td>
        <td>
