...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละผู้ป่วย DM ที่มีภาวะไตเสื่อม (CKD) Stage4
  <a href="javascript:popup('../chart/chart_ckd_ncd_stage4_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart 

 <a href="../exportxls/ckd_stage4_amp_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&id=<?php echo $id ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>     
   </a>
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('ckd_ncd_stage4_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>
