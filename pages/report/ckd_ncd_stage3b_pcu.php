...
?>
<a href="../exportxls/ckd_stage3b_pcu_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&ampcode=<?php echo $ampcode ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
  <div class="panel-body">
  A = จำนวนผู้ป่วย DM ที่ได้รับการคัดกรองภาวะแทรกซ้อนทางไตพบ CKD stage3b <br>
...
?>    
	<tr>
		<td>
         <a href="javascript:popup('ckd_ncd_stage3b_pcu_cid.php?hcode=<?php echo $arr_rs['HCODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['HNAME']; ?></a></td>
      ...
      <!--  <td align="center"><a href="../exportxls/ckd_stage3b_export_excell.php?hcode=<?php echo $arr_rs['HCODE'];?>&id=<?php echo $id ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" title="ส่งออก Excell"><i class="fa fa-file-excel-o"></i></a>
    </td>-->
	</tr>
