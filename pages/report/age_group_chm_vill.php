...
<title>ข้อมูล กลุ่มอายุ <?php echo $age_m;?>เดือน ระดับหมู่บ้าน</title>
   <!-- Bootstrap Core CSS -->
...
?>    
    ...
    <tr>
     <?php 
	  ...
	  ?>
		<td>
         <a href="age_group_chm_cid.php?vhid=<?php echo $arr_rs['VHID'];?>&age_st=<?php echo $age_st;?>&age_end=<?php echo $age_end?>&table=<?php echo $table?>&age_m=<?php echo $age_m;?>"><?php echo $arr_rs['VILLNAME']; ?></a>     
		</td>
        <?php }else{?>
         <td>
         <a href="age_group_chm_cid_all.php?id=<?php echo $id;?>&tambon=<?php echo $tambon;?>&table=<?php echo $table;?>&age_st=<?php echo $age_st;?>&age_end=<?php echo $age_end;?>&age_m=<?php echo $age_m;?>"><?php echo $arr_rs['VILLNAME']; ?></a>     
		</td>
        <?php }?>
        <td>
