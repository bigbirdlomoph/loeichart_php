...
?>
<a href="../exportxls/labor_teen1519_pcu_export_excel.php?hcode=<?= $arr_rs['HCODE'];?>&id=<?= $id ;?>&ampcode=<?= $ampcode ;?>&b_year=<?= $b_year;?>&o_year=<?= $o_year;?>&ystr=<?= $ystr;?>&yend=<?= $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
  <div class="panel-body">
  A = จำนวนเด็กคลอดจากแม่อายุ 15-19 ปี (นับเฉพาะคลอดมีชีพ)  <br>
  B = จำนวนเด็กคลอดทั้งหมด (นับเฉพาะคลอดมีชีพ)  
...
<?php
 ...
 $dbrpt->Query("
				SELECT 
					...
					FROM s_labor_1519 
					LEFT JOIN z42_co_office_loei AS 42loei on 42loei.off_id = s_labor_1519.hospcode
...
?>    
	<tr>
		<td>
         <a href="javascript:popup('teenage_lborn_1519_pcu_cid.php?hcode=<?php echo $arr_rs['HCODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['HNAME']; ?></a></td>
        <td><?= $arr_rs['HCODE'];?></td>
        <td>
        <?php echo $arr_rs['B']; ?>
		</td>
        ...
        <!--<td align="center"><a href="../exportxls/labor_teen1519y_export_excell.php?hcode=<?php echo $arr_rs['HCODE'];?>&id=<?php echo $id ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" title="ส่งออก Excell"><i class="fa fa-file-excel-o"></i></a>
    </td>-->
	</tr>
