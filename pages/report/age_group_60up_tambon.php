...
<title>ข้อมูล กลุ่มอายุ <?php echo $age?> ปีขึ้นไป ระดับตำบล</title>
    <!-- Bootstrap Core CSS -->
...
<?php
 ...
 $dbrpt->GET_AGE_GROUP_TAMBON($table,$age,$ampcode);
while($arr_rs=$dbrpt->Fetch_array()){
	
?>    
	<tr>
		<td>
         <a href="age_group_60up_pcu.php?tambon=<?php echo $arr_rs['TBCODE'];?>&id=<?php echo $id;?>&age=<?php echo $age;?>&table=<?php echo $table;?>"><?php echo $arr_rs['TBNAME']; ?></a>     
		</td>
        <td>
