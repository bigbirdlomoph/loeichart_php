...
<a href="../exportxls/ht_ckd_stage4_age_m65_cid_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&hcode=<?php echo $hcode ;?>&id=<?php echo $id ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
...
<?php
 ...
 $dbrpt->Query("
    SELECT  
        ...
        AND t.LABRESULT BETWEEN '15.00' AND '29.99' AND t.AGE >='65';
		");
