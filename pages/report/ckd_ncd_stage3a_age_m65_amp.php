...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละผู้ป่วย DM ที่มีภาวะไตเสื่อม (CKD) Stage3a อายุมากกว่า 65 ปี
  <a href="javascript:popup('../chart/chart_ckd_age_m65_stage3a_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart
   </a>
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('ckd_ncd_stage3a_age_m65_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>
