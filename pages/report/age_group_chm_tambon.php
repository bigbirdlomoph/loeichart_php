...
<title>ข้อมูล กลุ่มอายุ <?php echo $age_m;?> เดือน ระดับตำบล</title>
     <!-- Bootstrap Core CSS -->
...
<?php
 ...
 $dbrpt->GET_AGE_GROUP_CHM_TAMBON($table,$age_m,$ampcode);
while($arr_rs=$dbrpt->Fetch_array()){
	
?>    
	<tr>
		<td>
         <a href="age_group_chm_pcu.php?tambon=<?php echo $arr_rs['TBCODE'];?>&id=<?php echo $id;?>&age_st=<?php echo $age_st;?>&age_end=<?php echo $age_end;?>&age_m=<?php echo $age_m;?>"><?php echo $arr_rs['TBNAME']; ?></a>     
		</td>
        <td>
