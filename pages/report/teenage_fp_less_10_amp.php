...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละของวัยรุ่นอายุน้อยกว่า 10 ปี ที่ได้รับบริการคุมกำเนิดหลังคลอดหรือแท้งก่อนออกจากโรงพยาบาล
  <a href="javascript:popup('../chart/chart_teenage_lborn_fp_less_10_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart
   </a>
  ...
  A = จำนวนหญิงอายุน้อยกว่า 10 ปีที่มาที่มารับบริการด้วยเรื่องคลอดหรือแท้งบุตร และได้รับบริการคุมกำเนิดก่อนออกจากโรงพยาบาล <br>
  B = จำนวนหญิงอายุน้อยกว่า 10 ปี ที่มาที่มารับบริการด้วยเรื่องคลอดหรือแท้งบุตรทั้งหมด
...
(
	SELECT 
				...
				FROM s_labor_fp_less_10 
				LEFT OUTER JOIN z42_amp AS amp ON LEFT(s_labor_fp_less_10.areacode,4)=amp.AMP_CODE
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('teenage_fp_less_10_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>
