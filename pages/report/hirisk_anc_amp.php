...
<!---->
 <div class="panel panel-info">
  <div class="panel-heading">หญิงตั้งครรภ์ที่มีภาวะเสี่ยง 
  <a href="javascript:popup('../chart/chart_anc_hr_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart
   </a>
  </div>
...
<thead>
          <tr>
             ...
             <th>อำเภอ</th>
              <th>จำนวนหญิงตั้งครรภ์ทั้งหมด</th>
...
(
	SELECT 
				...
				FROM  z42_anc_hr_s 
				LEFT OUTER JOIN z42_amp AS amp ON LEFT(z42_anc_hr_s.areacode,4)=amp.AMP_CODE
...
?>    
	<tr>
		<td>
         <a href="javascript:popup('hirisk_anc_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['AMPNAME']; ?></a>
