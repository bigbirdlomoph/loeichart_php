...
?>
<a href="../exportxls/ht_ckd_stage1_pcu_export_excel.php?hcode=<?php echo $arr_rs['HCODE'];?>&ampcode=<?php echo $ampcode ;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
...
<?php
 ...
 $dbrpt->Query("
        SELECT 
          ...
          FROM s_dv9_normal 
          left  OUTER JOIN z42_co_office_loei AS 42loei on 42loei.off_id = s_dv9_normal.hospcode
...
?>    
	<tr>
		<td>
         <a href="javascript:popup('child_dv9_normal_pcu_cid.php?hcode=<?php echo $arr_rs['HCODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['HNAME']; ?></a></td>
