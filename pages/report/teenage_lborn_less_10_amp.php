...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละของการคลอดโดยมารดาที่มีอายุน้อยกว่า 10 ปี ต่อการคลอดทั้งหมด
  <a href="javascript:popup('../chart/chart_teenage_lborn_less_10_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart
   </a>

</div>
     <div class="panel-body">
  A = จำนวนเด็กคลอดจากแม่อายุน้อยกว่า 10 ปี (นับเฉพาะคลอดมีชีพ) <br>
...
<thead class="bg-success">
  ...
  <tr>
    <td><div align="center"><strong>อำเภอ</strong></div></td>
    <td><div align="center"><strong>B</strong></div></td>
    <td><div align="center"><strong>A</strong></div></td>
    <td><div align="center"><strong>ร้อยละ</strong></div></td>
...
(
	SELECT 
				...
				FROM s_labor_less_10 
				LEFT OUTER JOIN z42_amp AS amp ON LEFT(s_labor_less_10.areacode,4)=amp.AMP_CODE
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('teenage_lborn_less_10_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>
