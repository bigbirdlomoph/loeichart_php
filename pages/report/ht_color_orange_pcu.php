...
SELECT 
        ...
        FROM z42_s_ht_color 
        left  OUTER JOIN z42_co_office_loei AS 42loei on 42loei.off_id = z42_s_ht_color.hospcode
...
?>    
	<tr>
		<td>
         <a href="javascript:popup('ht_color_orange_pcu_cid.php?hcode=<?php echo $arr_rs['HCODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)" ><?php echo $arr_rs['HNAME']; ?></a>
        </td>
