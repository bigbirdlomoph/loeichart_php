...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">จำนวนผู้ป่วยความดันโลหิตสูง สีดำ 
  <a href="javascript:popup('../chart/chart_ht_color_black_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart
   </a>

</div>
     <div class="panel-body">
    A = จำนวนผู้ป่วยความดันโลหิตสูงที่มีที่มีภาวะแทรกซ้อนทาง ไต หัวใจ<br>
...
<thead align="center">
          <tr>
            ...
            <th><div align="center">สีดำ</div></th>
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('ht_color_black_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['AMPNAME']; ?></a>
