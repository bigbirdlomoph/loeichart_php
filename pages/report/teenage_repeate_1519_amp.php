...
?>
 ...
 <div class="panel panel-info">
  <div class="panel-heading">ร้อยละของการตั้งครรภ์ซ้ำในวัยรุ่นอายุ 15-19 ปี
  <a href="javascript:popup('../chart/chart_teenage_lborn_repeate_1519_amp.php?ystr=<?php echo $ystr;?>&yend=<?php echo $yend?>','',960,500)"class="btn btn-default btn-sm " role="button">
   View Chart
   </a>
  ...
  A = จำนวนหญิงอายุ 15 – 19 ปีที่มาที่มารับบริการด้วยเรื่องคลอดหรือแท้งบุตร และเป็นการตั้งครรภ์ครั้งที่ 2 ขึ้นไป <br>
...
(
	SELECT 
				...
				FROM s_labor_repeate_1519 
				LEFT OUTER JOIN z42_amp AS amp ON LEFT(s_labor_repeate_1519.areacode,4)=amp.AMP_CODE
...
?>    
	<tr>
		...
		<td align="center">
         <a href="javascript:popup('teenage_repeate_1519_pcu.php?ampcode=<?php echo $arr_rs['AMPCODE'];?>&id=<?php echo $id;?>
