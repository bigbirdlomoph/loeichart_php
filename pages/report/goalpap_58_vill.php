...
?>
<a href="../exportxls/goalpap_58_vill_export_excel.php?villid=<?=$villid;?>&hcode=<?=$hcode;?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>" class="btn btn-default btn-sm" role="button">ส่งออก Excel </a>
</div>
  <div class="panel-body">
  A = ประชากรหญิง อายุ 30-60 ปี ที่ได้รับการคัดกรองมะเร็งปากมดลูก ตั้งแต่ 1 เมษายน 2554  <br>
  B = ประชากรหญิง อายุ 30-60 ปี ที่ได้รับการคัดกรองมะเร็งปากมดลูก ในปีงบประมาณ 2558 <br>
...
?>    
	<tr>
		<td>
        <a href="javascript:popup('goalpap_58_pcu_cid.php?villid=<?php echo $arr_rs['VILLCODE'];?>&hcode=<?php echo $arr_rs['HCODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['VNAME']; ?></a></td>
