...
<?php
 ...
 $dbrpt->Query("
                SELECT 
                    ...
                    left  OUTER JOIN z42_co_office_loei AS 42loei on 42loei.off_id = s_labor_fp_less_10.hospcode
...
?>    
	<tr>
		<td>
         <a href="javascript:popup('teenage_fp_less_10_pcu_cid.php?hcode=<?php echo $arr_rs['HCODE'];?>&b_year=<?php echo $b_year;?>&ystr=<?php echo $ystr;?>&yend=<?php echo $yend;?>','',960,500)"><?php echo $arr_rs['HNAME']; ?></a></td>
